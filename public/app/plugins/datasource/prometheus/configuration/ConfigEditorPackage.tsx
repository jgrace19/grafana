...
import { configEditorPackageStyles } from './ConfigEditorPackage.stylex';
...
export const ConfigEditor = (props: Props) => {
  ...
  return (
    <>
      ...
      <hr
        className={clsx(
          stylex.props(configEditorPackageStyles.hrTopSpace).className,
          stylex.props(configEditorPackageStyles.hrBottomSpace).className
        )}
      />
      ...
      <hr />
      <ConfigSection
        className={stylex.props(configEditorPackageStyles.advancedSettings).className}
        title="Advanced settings"
        description="Additional settings are optional settings that can be configured for more control over your data source."
      >
        <AdvancedHttpSettings
          className={stylex.props(configEditorPackageStyles.advancedHTTPSettingsMargin).className}
          config={options}
