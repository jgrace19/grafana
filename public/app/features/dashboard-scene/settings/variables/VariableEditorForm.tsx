...
import { variableEditorFormStyles } from './VariableEditorForm.stylex';
...
export function VariableEditorForm({ variable, onTypeChange, onGoBack, onDelete }: VariableEditorFormProps) {
  ...
  return (
    ...
    >
      ...
      <div {...stylex.props(variableEditorFormStyles.buttonContainer)}>
        <Stack gap={2}>
          <ModalsController>
            {({ showModal, hideModal }) => (
              <Button
          ...
          {isHasVariableOptions && (
            ...
            >
              {runQueryState.loading ? (
                <LoadingPlaceholder
                  {...stylex.props(variableEditorFormStyles.loadingPlaceHolder)}
