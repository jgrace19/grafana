...
import { variableSetEditableElementStyles } from './VariableSetEditableElement.stylex';
          ...
          {list.map((variable, index) => (
            ...
            >
              {(draggableProvided) => (
                ...
                <div
                  {...stylex.props(variableSetEditableElementStyles.variableItem)}
                  key={variable.state.name}
                  onClick={() => onEditVariable(variable)}
                  ref={draggableProvided.innerRef}
                  {...draggableProvided.draggableProps}
                >
                  <div {...stylex.props(variableSetEditableElementStyles.variableContent)}>
                    <div {...draggableProvided.dragHandleProps} onPointerDown={onPointerDown}>
                      <Tooltip content={t('dashboard.edit-pane.variables.reorder', 'Drag to reorder')} placement="top">
                        <Icon name="draggabledots" size="md" {...stylex.props(variableSetEditableElementStyles.dragHandle)} />
                      </Tooltip>
                    </div>
                    <Text>${variable.state.name}</Text>
                    {variable.state.hide === VariableHide.hideVariable && (
                      <Icon name="eye-slash" size="sm" {...stylex.props(variableSetEditableElementStyles.hiddenIcon)} />
                    )}
                    {variable.state.hide === VariableHide.inControlsMenu && (
                      <Icon name="sliders-v-alt" size="sm" {...stylex.props(variableSetEditableElementStyles.hiddenIcon)} />
                    )}
                  </div>
