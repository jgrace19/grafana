    ...
    <Draggable key={key!} draggableId={key!} index={myIndex} isDragDisabled={!isDraggable}>
      {(dragProvided, dragSnapshot) => (
        <div
          ...
          {...stylex.props(dragSnapshot.isDragging && styles.dragging)}
          ...
          <Tab
            ...
            className={clsx(
              stylex.props(
                ...
                (isSelected || isSourceSelected) && !isParentDropTarget && styles.selectedTab
              ).className,
...
const styles = stylex.create({
  ...
  tabContentContainer: {
    ...
    minHeight: `calc(${spacing['--gf-spacing-grid-size']} * 1.125)`,
