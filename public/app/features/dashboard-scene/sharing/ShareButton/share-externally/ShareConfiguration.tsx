...
import { shareConfigurationStyles } from './ShareConfiguration.stylex';
          ...
          <FieldSet disabled={disableForm}>
            <Stack direction="column" gap={2}>
              ...
              <Stack gap={1} alignItems="flex-start">
                <div {...stylex.props(shareConfigurationStyles.timeRange)}>
                  <Trans i18nKey="public-dashboard.configuration.time-range-label">Time range</Trans>
                </div>
                <div {...mergeStylexClassName(stylex.props(shareConfigurationStyles.timeRange), clsx(shareConfigurationStyles.timeRangeValue))}>
