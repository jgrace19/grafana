...
import { configureCorrelationSourceFormStyles } from './ConfigureCorrelationSourceForm.stylex';
    ...
    return (
      <>
        {variables.map((name, i) => (
          <span {...stylex.props(configureCorrelationSourceFormStyles.variable)} key={i}>
            {name}
      ...
      <FieldSet label={formText.title}>
        ...
        <Stack direction="column" gap={2}>
          ...
          <Field
            ...
            {...stylex.props(configureCorrelationSourceFormStyles.label)}
            ...
            <Card noMargin>
              ...
              <Card.Description>
                ...
                <Trans i18nKey="correlations.source-form.description">
                  ...
                  <span {...stylex.props(configureCorrelationSourceFormStyles.variable)}>logfmt</span> will create variables for every key/value pair.
                </Trans>
              </Card.Description>
            </Card>
          )}
