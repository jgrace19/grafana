...
import { logsTableStyles } from './LogsTable.stylex';
...
export function LogsTable(props: Props) {
  ...
  const prepareTableFrame = useCallback(
          ...
          custom: {
              ...
              ? {
                  ...
                  cellComponent: (cellProps: CustomCellRendererProps) => (
                    <>
                      ...
                      />
                      <span {...stylex.props(logsTableStyles.firstColumnCell)}>
            ...
            headerComponent: isFirstField
              ? (headerProps: { defaultContent: React.ReactNode }) => (
                  <div {...stylex.props(logsTableStyles.firstColumnHeader)}>{headerProps.defaultContent}</div>
                )
    ...
    [
      ...
      logsFrame,
      timeIndex,
      mergeStylexClassName(stylex.props(logsTableStyles.firstColumnCell), undefined).className,
      mergeStylexClassName(stylex.props(logsTableStyles.firstColumnHeader), undefined).className,
