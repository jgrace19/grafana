...
import './SpanDetailLinkButtons.css';
  ...
  return (
    <Dropdown overlay={menu} placement="bottom-start" onVisibleChange={setIsOpen}>
      <Button
        ...
        icon="link"
        size="sm"
        className="gf-trace-link-button"
