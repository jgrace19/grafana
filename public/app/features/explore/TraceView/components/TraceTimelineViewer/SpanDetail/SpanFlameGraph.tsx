...
import { spanFlameGraphStyles } from './SpanFlameGraph.stylex';
...
export default function SpanFlameGraph(props: SpanFlameGraphProps) {
  ...
  return (
    <div {...stylex.props(spanFlameGraphStyles.flameGraph)} ref={sizeRef}>
      <div {...stylex.props(spanFlameGraphStyles.flameGraphTitle)}>
