  ...
  return (
    ...
    >
      ...
      <g className="propeller-group">
        <path
          {...stylex.props(styles.propeller, styles.propellerCW)}
        ...
        />
        <path
          {...stylex.props(styles.propeller, styles.propellerCCW)}
...
// Referenced by name from the inline `animation` shorthand, which also resets animation-direction.
