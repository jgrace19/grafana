    ...
    <Stack direction="column" gap={1}>
      <Stack justifyContent="space-between" alignItems="center">
        <Stack alignItems="center">
          <span {...mergeStylexClassName(stylex.props(versionHistoryComparisonStyles.versionInfo, , mergeStylexClassName(stylex.props(versionHistoryComparisonStyles.noMarginBottom), undefined).className), undefined)}>
            <Trans
