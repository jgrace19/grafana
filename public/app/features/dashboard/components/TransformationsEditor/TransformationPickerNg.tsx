...
import { transformationPickerNgStyles } from './TransformationPickerNg.stylex';
  ...
  return (
    ...
    >
      <Stack direction="column" gap={2}>
        ...
        <div {...stylex.props(transformationPickerNgStyles.searchWrapper)}>
          <Input
            data-testid={selectors.components.Transforms.searchInput}
            {...stylex.props(transformationPickerNgStyles.searchInput)}
            value={search ?? ''}
            placeholder={t(
          ...
          <Stack direction="row" alignItems="center" gap={0.5}>
            <span {...stylex.props(transformationPickerNgStyles.switchLabel)}>
