...
import { connectDataStyles } from './ConnectData.stylex';
...
export function AddNewConnection() {
  ...
  return (
    <>
      ...
      <div {...stylex.props(connectDataStyles.searchContainer)}>
        <HorizontalGroup wrap>
          <Field label={t('common.search', 'Search')}>
            <SearchField value={searchTerm} onSearch={handleSearchChange} />
          </Field>
          <HorizontalGroup {...stylex.props(connectDataStyles.actionBar)}>
      ...
      <div {...stylex.props(connectDataStyles.contentWrap)}>
        {isLoading ? (
          ...
          <>
            ...
            {appsPlugins.length > 0 && (
              <>
                <div {...stylex.props(connectDataStyles.spacer)} />
