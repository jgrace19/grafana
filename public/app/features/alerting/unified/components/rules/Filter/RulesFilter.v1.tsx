  ...
  return (
    <Stack direction="column" gap={0}>
      <Stack direction="row" gap={1} wrap="wrap">
        <Field
          noMargin
          className={stylex.props(styles.dsPickerContainer).className}
          label={
        ...
        <Field
          className={stylex.props(styles.dashboardPickerContainer).className}
          label={
...
const styles = stylex.create({
  dsPickerContainer: {
    width: `calc(${spacing['--gf-spacing-grid-size']} * 60)`,
    flexGrow: 0,
  },
  dashboardPickerContainer: {
    minWidth: `calc(${spacing['--gf-spacing-grid-size']} * 50)`,
  },
  searchInput: {
    flex: '1',
    margin: 0,
