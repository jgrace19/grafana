...
export function RuleNotificationSection() {
  ...
  return (
    <section {...stylex.props(styles.section)} aria-labelledby="notification-section-heading">
        ...
        <Stack direction="column" gap={2}>
          <Stack direction="column" gap={1}>
            <Stack direction="column" gap={1}>
              <Stack direction="row" alignItems="end" justifyContent="space-between" gap={1}>
                ...
                <div {...stylex.props(styles.manualRoutingInline)}>
                  <RadioButtonGroup
                    size="sm"
                    options={[
                      {
            ...
            {useNotificationPolicy ? (
              <div {...stylex.props(styles.contentTopSpacer)}>
                <Stack direction="column" gap={2}>
          ...
          >
            <>
              ...
              />
              {runbookUrlError && (
                <div id={runbookUrlErrorId} role="alert" {...stylex.props(styles.runbookUrlError)}>
