      ...
      <form onSubmit={formAPI.handleSubmit(onSave)}>
        <Stack direction="column" gap={4}>
          ...
          <Stack direction="column" gap={1}>
            ...
            <Space v={1} />
            <div {...stylex.props(styles.confirmButton)}>
  ...
  return (
    <Stack direction="column" gap={2} alignItems="flex-start">
      {fields.map((field, index) => {
        ...
        return (
          <div key={field.id} {...stylex.props(styles.flexRow, styles.centerAlignRow)}>
            <Field
              noMargin
  ...
  return (
    <>
      {fields.map((field, index) => {
        return (
          <div key={field.id}>
            <div {...stylex.props(styles.flexRow, styles.centerAlignRow)} data-testid="alertlabel-input-wrapper">
              <Field
                noMargin
                className={stylex.props(styles.labelInput).className}
