...
import { needHelpInfoStyles } from './NeedHelpInfo.stylex';
...
export function NeedHelpInfo({ contentText, externalLink, linkText, title = 'Need help?' }: NeedHelpInfoProps) {
  ...
  return (
    <Toggletip
      content={<div {...stylex.props(needHelpInfoStyles.mutedText)}>{contentText}</div>}
      title={
    ...
    >
      <div {...stylex.props(needHelpInfoStyles.helpInfo)}>
