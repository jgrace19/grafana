...
export function SavedSearchItem({
  ...
  if (isRenaming) {
    return (
      ...
      <div {...stylex.props(styles.item)} role="listitem" onClick={(e) => e.stopPropagation()}>
        <InlineRenameInput
  ...
  return (
    <div {...stylex.props(styles.item)} role="listitem">
      <Stack direction="row" alignItems="center" gap={1} wrap={false}>
        ...
        <div {...stylex.props(styles.actionMenuWrapper)} onClick={(e) => e.stopPropagation()}>
          <ActionMenu
