...
const Policy = (props: PolicyComponentProps) => {
  ...
  return (
    <Stack direction="column" gap={1.5}>
      <div
        {...stylex.props(styles.policyWrapper, hasFocus && styles.policyWrapperFocus)}
      ...
      >
        ...
        <div {...stylex.props(styles.gutterIconStack)}>
        ...
        <div {...stylex.props(styles.policyItemWrapper)}>
      ...
      <div {...stylex.props(styles.childPolicies)}>
        {showPolicyChildren && (
          <>
            ...
            {showMore && (
              <Button
                ...
                icon="angle-down"
                variant="secondary"
                className={stylex.props(styles.moreButtons).className}
...
const AllMatchesIndicator: FC = () => {
  return (
    ...
    >
      <div {...stylex.props(styles.gutterIcon)} data-testid="matches-all">
...
const ErrorsGutterIndicator: FC<{ errors: React.ReactNode[] }> = ({ errors }) => {
  return (
    ...
    >
      <div {...stylex.props(styles.gutterIcon, styles.gutterIconError)} data-testid="policy-errors">
...
const styles = stylex.create({
  ...
  gutterIconStack: {
    position: 'absolute',
    top: spacing['--gf-spacing-x1-5'], // Align with policyItemWrapper padding
    left: `calc(${spacing['--gf-spacing-x4']} * -1)`,
    display: 'flex',
  ...
  gutterIconError: {
    ...
    borderColor: colors['--gf-colors-error-border-transparent'],
  },
  moreButtons: {
