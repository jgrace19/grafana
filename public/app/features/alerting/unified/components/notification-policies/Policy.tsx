...
import { policyStyles } from './Policy.stylex';
...
const Policy = (props: PolicyComponentProps) => {
  ...
  return (
    <Stack direction="column" gap={1.5}>
      <div
        className={policyStyles.policyWrapper(hasFocus)}
      ...
      >
        ...
        <div {...stylex.props(policyStyles.gutterIconStack)}>
        ...
        <div {...stylex.props(policyStyles.policyItemWrapper)}>
          <Stack direction="column" gap={1}>
            ...
            <>
              ...
              <Stack direction="row" alignItems="center" gap={1} wrap="wrap-reverse">
                ...
                {isImmutablePolicy && (
                  <div {...stylex.props(policyStyles.noShrink)}>
                ...
                {!isImmutablePolicy && (
                  <>
                    {hasMatchers ? (
                      ...
                      <span {...stylex.props(policyStyles.metadata)}>
      ...
      <div {...stylex.props(policyStyles.childPolicies)}>
        {showPolicyChildren && (
          <>
            ...
            {showMore && (
              <Button
                ...
                icon="angle-down"
                variant="secondary"
                {...stylex.props(policyStyles.moreButtons)}
...
export function MetadataRow({
  ...
  return (
    <div {...stylex.props(policyStyles.metadataRow)}>
...
const ContinueMatchingIndicator: FC = () => {
  ...
  return (
    ...
    >
      <div className={policyStyles.gutterIcon()} data-testid="continue-matching">
...
const AllMatchesIndicator: FC = () => {
  ...
  return (
    ...
    >
      <div className={policyStyles.gutterIcon()} data-testid="matches-all">
...
const ErrorsGutterIndicator: FC<{ errors: React.ReactNode[] }> = ({ errors }) => {
  ...
  return (
    ...
    >
      <div className={policyStyles.gutterIcon(true)} data-testid="policy-errors">
