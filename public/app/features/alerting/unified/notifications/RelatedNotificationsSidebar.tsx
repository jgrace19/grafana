...
export function RelatedNotificationsSidebar({
  ...
  return (
    <Stack direction="column" gap={1}>
      {batches.map((batch) => (
        <div key={batch.pipelineTime} {...mergeStylexClassName(stylex.props(formStyles.relatedRow), batch.hasCurrent && stylex.props(formStyles.relatedRowCurrent))}>
          <Stack direction="column" gap={0.5}>
            <Stack direction="row" gap={1} alignItems="center" wrap="wrap">
              ...
              {batch.allRetry && (
                ...
                >
                  <Icon name="sync" size="sm" {...stylex.props(relatedNotificationsSidebarStyles.subtleIcon)} />
                </Tooltip>
              )}
            </Stack>
            <Stack direction="row" gap={1} alignItems="center" wrap="wrap">
              ...
              {batch.failedCount > 0 ? (
                <Stack direction="row" gap={0.5} alignItems="center">
                  <Icon name="exclamation-circle" size="sm" {...stylex.props(relatedNotificationsSidebarStyles.errorIcon)} />
                ...
                <Stack direction="row" gap={0.5} alignItems="center">
                  <Icon name="check-circle" size="sm" {...stylex.props(relatedNotificationsSidebarStyles.successIcon)} />
            ...
            {batch.notifications.map((n) => {
              ...
              return (
                <div key={n.uuid} {...stylex.props(relatedNotificationsSidebarStyles.batchItem)}>
                  <Stack direction="row" gap={0.5} alignItems="center">
                  ...
                  {n.outcome === 'error' ? (
                    <Icon name="exclamation-circle" size="xs" {...stylex.props(relatedNotificationsSidebarStyles.errorIcon)} />
                  ) : (
                    <Icon name="check-circle" size="xs" {...stylex.props(relatedNotificationsSidebarStyles.successIcon)} />
                  )}
                </div>
              );
            })}
